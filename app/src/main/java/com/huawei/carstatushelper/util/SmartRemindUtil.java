...
public class SmartRemindUtil {
    ...
    public static String getGearboxLevelName(Context context, int level) {
        ...
        String name_p = preferences.getString("gearbox_level_p_content", "");
        String name_r = preferences.getString("gearbox_level_r_content", "");
        String name_n = preferences.getString("gearbox_level_n_content", "");
        String name_d = preferences.getString("gearbox_level_d_content", "");
    ...
    public static String getWelcomeContent(Context context){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        String welcome = preferences.getString("boot_welcome_tts_content", "");
        return welcome;
    }
