...
import com.huawei.carstatushelper.DataHolder;
...
public class CarStatusDetailActivity extends BackEnableBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.setVariable(R.id.data, dataHolder);
    ...
    private void initDeviceData() {
        ...
        dataHolder.setTyrePressure(tyrePressureValueLeftFront + " " + tyrePressureValueRightFront + " " + tyrePressureValueLeftRear + " " + tyrePressureValueRightRear);
        ...
        int waterTemperature = statisticDeviceHelper.getWaterTemperature();
    ...
    private final AbsBYDAutoStatisticListener statisticListener = new AbsBYDAutoStatisticListener() {
        ...
        public void onWaterTemperatureChanged(int value) {
            dataHolder.setWaterTemperature(value + "");
            refreshUI();
        }

        public void onInstantElecConChanged(double value) {
            dataHolder.setInstantElecCon(value + "");
            refreshUI();
        }

        public void onInstantFuelConChanged(double value) {
            dataHolder.setInstantFuelCon(value + "");
            refreshUI();
        }
    };
    ...
    private final AbsBYDAutoBodyworkListener bodyworkListener = new AbsBYDAutoBodyworkListener() {
        ...
        public void onPowerLevelChanged(int level) {
            ...
            dataHolder.setPowerLevel(level + "");
            refreshUI();
        }
    ...
    private final AbsBYDAutoEngineListener engineListener = new AbsBYDAutoEngineListener() {
        ...
        public void onEngineSpeedChanged(int value) {
            ...
            dataHolder.setEngineSpeed(value + "");
            refreshUI();
        }
    ...
    private final AbsBYDAutoEnergyListener energyListener = new AbsBYDAutoEnergyListener() {
        ...
        public void onEnergyModeChanged(int mode) {
            ...
            dataHolder.setEnergyMode(StringUtil.getEnergyModeName(mode));
            refreshUI();
        }
        ...
        public void onOperationModeChanged(int mode) {
            ...
            dataHolder.setOperationMode(StringUtil.getOperationModeName(mode));
            refreshUI();
        }
    ...
    private final AbsBYDAutoTyreListener tyreListener = new AbsBYDAutoTyreListener() {
        ...
        final int[] tyrePressureValues = new int[8];

        @Override
        public void onTyrePressureValueChanged(int area, int value) {
            super.onTyrePressureValueChanged(area, value);
            tyrePressureValues[area] = value;
            dataHolder.setTyrePressure(Arrays.toString(tyrePressureValues));
            refreshUI();
        }
    };
    ...
    private final AbsBYDAutoSensorListener sensorListener = new AbsBYDAutoSensorListener() {
        ...
        public void onTemperatureSensorValueChanged(double value) {
            ...
            dataHolder.setSensorTemperature(format.format(value));
            refreshUI();
        }
        ...
        public void onHumiditySensorValueChanged(double value) {
            ...
            dataHolder.setSensorHumidity(format.format(value));
            refreshUI();
        }
        ...
        public void onLightIntensityChanged(int value) {
            ...
            dataHolder.setSensorLight(value + "");
            refreshUI();
        }
        ...
        public void onSlopeValueChanged(int value) {
            ...
            dataHolder.setSensorSlop(value + "");
            refreshUI();
        }
    };
    ...
    private final AbsBYDAutoChargingListener chargingListener = new AbsBYDAutoChargingListener() {
        ...
        public void onChargingCapacityChanged(double value) {
            ...
            dataHolder.setCurrentChargingCount(format.format(value));
            refreshUI();
        }
    };
}